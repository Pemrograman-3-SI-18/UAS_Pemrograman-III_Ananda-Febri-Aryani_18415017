  ...
  <q-layout view="lHh Lpr lFf">
            ...
            <div class="row no-wrap q-pa-lg">
              ...
              <div class="column items-center">
                <q-btn flat round dense>
                  <q-avatar size="72px">
                    <q-img spinner-color="white" placeholder-src="statics/logo.jpg" src="statics/logo.jpg">
                    </q-img>
                  </q-avatar>
                </q-btn>
    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-green-6 text-bold">
            <q-item-section>
              Aplikasi Penjualan Peralatan Tinju
            </q-item-section>
          </q-item>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pelanggan">
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pelanggan/transaksi">
            <q-item-section avatar>
              <q-icon name="input" />
            </q-item-section>
            <q-item-section>
